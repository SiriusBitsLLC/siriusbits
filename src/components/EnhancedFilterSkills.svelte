    ...
    <div class="skills-sidebar {isFilterVisible ? 'visible' : ''}">
      ...
      <div class="skill-filters">
        {#each skills as skill}
          <button
            class="skill-filter-btn {isSkillSelected(skill.id)
              ? 'selected'
              : ''}"
      ...
      <div class="results-container {resultsVisible ? 'visible' : ''}">
        ...
        {:else if filteredDuties.length === 0}
          <div class="no-results-card">
            ...
            >
              <path
                d="M10 3H3v7M21 14v7h-7M3.51 9A9 9 0 0 0 5.64 19M18.36 5a9 9 0 0 1 2.13 10"
                stroke="currentColor"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        {:else}
          {#each filteredDuties as duty, index}
            <div class="duty-card" style="--delay: {index * 0.1}s">
              <h4>{duty.duties}</h4>
