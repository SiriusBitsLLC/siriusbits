<script lang="ts">
  ...
  const icons: { [key: string]: string } = {
    ...
    'alert': 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
    ...
    'map-pin': 'M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z M12 10a1 1 0 1 0 0-2 1 1 0 0 0 0 2z',
    ...
    // Experience icons
    'briefcase': 'M20 7h-4V3H8v4H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16',
    'calendar': 'M19 4H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z M16 2v4 M8 2v4 M3 10h18',
    'award': 'M12 15c2.21 0 4-1.79 4-4 0-2.21-1.79-4-4-4-2.21 0-4 1.79-4 4 0 2.21 1.79 4 4 4z M8.59 13.51l-5.66 5.65 M15.41 13.51l5.66 5.65',
    ...
    'users': 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M23 21v-2a4 4 0 0 0-3-3.87 M16 7a4 4 0 0 1 0 7.75 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z'
  };
  ...
  const isComplexIcon = iconPath.includes('<path') || iconPath.includes('<line') || 
                        iconPath.includes('<polygon') || iconPath.includes('<polyline') || 
                        iconPath.includes('<rect') || iconPath.includes('<ellipse');
</script>

<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" class="icon {className}" aria-hidden="true">
  {#if iconExists}
    {#if isComplexIcon}
      {@html iconPath}
    {:else}
    ...
    {/if}
  {:else}
    <!-- Fallback icon (question mark) if icon not found -->
